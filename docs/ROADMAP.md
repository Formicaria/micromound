...
4. **What comes immediately after that?** M5 — the ESP32 as a subordinate deterministic controller
   ...
   golden fixtures. Not a second colony. Its protocol layer already exists: `firmware/micromound-c`,
   the encoder, signer, reader and validators in C, proven against the fixtures on the host
   (`v0.9.18`–`v0.9.19`).
