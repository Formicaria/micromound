...
3. **What must exist before real hardware can move?** M4, **in progress**: the durable file-backed
   ...
   (`v0.9.6`), and device enrollment over that transport (`v0.9.7`). Still remaining: the real Linux
   driver *ports* behind the primitives. The daemon runs against generic primitives until those land.
