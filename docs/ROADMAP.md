...
5. **When is Micromound physically usable?** At the **Generic Physical Mound** acceptance below —
   ...
   architecture and a functional physical edge colony. As of `v0.9.27` every one of its criteria is
   met in software ([`ACCEPTANCE.md`](ACCEPTANCE.md)); what is left is the wiring.
